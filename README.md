...
|---|---|---|
| Uke (7d) | **62%** 🟢 | ↑ +7pp siste 24t · nullstilles 2026-08-31 |
| Sesjon (5t) | 1% | nullstilles 03:20 UTC |
| Siste 7 dager | topp 82% · snitt 44% | 15t i sparemodus |

<sub>Oppdatert 2026-08-29 01:47 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
