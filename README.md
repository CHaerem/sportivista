...
|---|---|---|
| Uke (7d) | **18%** 🟢 | ↑ +14pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 11% | nullstilles 14:30 UTC |
| Siste 7 dager | topp 92% · snitt 61% | 55t i sparemodus |

<sub>Oppdatert 2026-08-18 10:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
