...
|---|---|---|
| Uke (7d) | **78%** 🟡 | ↑ +5pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 5% | nullstilles 17:50 UTC |
| Siste 7 dager | topp 78% · snitt 46% | 13t i sparemodus |

<sub>Oppdatert 2026-08-14 17:14 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
