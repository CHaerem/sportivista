...
| Siste 7 dager | topp 100% · snitt 64% | 35t i sparemodus |

<sub>Oppdatert 2026-07-25 15:31 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
