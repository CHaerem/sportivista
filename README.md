...
| Siste 7 dager | topp 100% · snitt 61% | 29t i sparemodus |

<sub>Oppdatert 2026-07-24 20:41 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
