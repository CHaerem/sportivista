...
|---|---|---|
| Uke (7d) | **59%** 🟢 | ↑ +8pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 3% | nullstilles 21:50 UTC |
| Siste 7 dager | topp 92% · snitt 49% | 40t i sparemodus |

<sub>Oppdatert 2026-08-21 20:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
