...
|---|---|---|
| Uke (7d) | **65%** 🟢 | ↑ +56pp siste 24t · nullstilles 2026-09-21 |
| Sesjon (5t) | 35% | nullstilles 16:00 UTC |
| Siste 7 dager | topp 65% · snitt 31% | 0t i sparemodus |

<sub>Oppdatert 2026-09-18 14:32 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
