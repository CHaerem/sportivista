...
|---|---|---|
| Uke (7d) | **29%** 🟢 | ↑ +6pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 2% | nullstilles 00:20 UTC |
| Siste 7 dager | topp 100% · snitt 55% | 30t i sparemodus |

<sub>Oppdatert 2026-07-30 19:56 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
