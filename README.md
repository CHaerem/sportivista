...
|---|---|---|
| Uke (7d) | **53%** 🟢 | ↑ +1pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 3% | nullstilles 18:40 UTC |
| Siste 7 dager | topp 68% · snitt 34% | 1t i sparemodus |

<sub>Oppdatert 2026-08-12 18:10 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
