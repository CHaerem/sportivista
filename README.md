...
| Siste 7 dager | topp 85% · snitt 40% | 9t i sparemodus |

<sub>Oppdatert 2026-09-20 17:30 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
