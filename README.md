...
|---|---|---|
| Uke (7d) | **78%** 🟡 | ↑ +3pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 2% | nullstilles 22:50 UTC |
| Siste 7 dager | topp 78% · snitt 48% | 16t i sparemodus |

<sub>Oppdatert 2026-08-14 19:59 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
