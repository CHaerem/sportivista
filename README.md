...
| Sesjon (5t) | 0% | nullstilles 22:10 UTC |
| Siste 7 dager | topp 100% · snitt 66% | 37t i sparemodus |

<sub>Oppdatert 2026-07-25 22:13 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
