...
| Sesjon (5t) | 1% | nullstilles 12:20 UTC |
| Siste 7 dager | topp 47% · snitt 22% | 0t i sparemodus |

<sub>Oppdatert 2026-08-08 08:04 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
