...
| Sesjon (5t) | 0% | nullstilles 00:40 UTC |
| Siste 7 dager | topp 100% · snitt 63% | 37t i sparemodus |

<sub>Oppdatert 2026-07-29 19:47 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
