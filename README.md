...
| Sesjon (5t) | 7% | nullstilles 19:40 UTC |
| Siste 7 dager | topp 90% · snitt 65% | 52t i sparemodus |

<sub>Oppdatert 2026-08-16 19:37 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
