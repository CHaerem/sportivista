...
| Sesjon (5t) | 1% | nullstilles 18:10 UTC |
| Siste 7 dager | topp 92% · snitt 53% | 55t i sparemodus |

<sub>Oppdatert 2026-08-20 13:14 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
