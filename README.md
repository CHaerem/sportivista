...
|---|---|---|
| Uke (7d) | **41%** 🟢 | ↑ +33pp siste 24t · nullstilles 2026-09-28 |
| Sesjon (5t) | 10% | nullstilles 01:00 UTC |
| Siste 7 dager | topp 86% · snitt 44% | 11t i sparemodus |

<sub>Oppdatert 2026-09-22 22:16 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
