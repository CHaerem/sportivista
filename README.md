...
|---|---|---|
| Uke (7d) | **51%** 🟢 | ↑ +16pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 11% | nullstilles 23:20 UTC |
| Siste 7 dager | topp 92% · snitt 52% | 54t i sparemodus |

<sub>Oppdatert 2026-08-20 19:48 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
