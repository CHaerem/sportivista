...
| Siste 7 dager | topp 79% · snitt 49% | 18t i sparemodus |

<sub>Oppdatert 2026-08-14 21:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
