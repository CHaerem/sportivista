...
| Sesjon (5t) | 8% | nullstilles 19:30 UTC |
| Siste 7 dager | topp 92% · snitt 59% | 55t i sparemodus |

<sub>Oppdatert 2026-08-18 16:52 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
