...
|---|---|---|
| Uke (7d) | **53%** 🟢 | ↑ +2pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 2% | nullstilles 18:40 UTC |
| Siste 7 dager | topp 68% · snitt 34% | 1t i sparemodus |

<sub>Oppdatert 2026-08-12 16:13 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
