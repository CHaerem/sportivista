...
|---|---|---|
| Uke (7d) | **87%** 🟡 | ↑ +5pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 1% | nullstilles 14:40 UTC |
| Siste 7 dager | topp 87% · snitt 62% | 43t i sparemodus |

<sub>Oppdatert 2026-08-16 10:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
