...
|---|---|---|
| Uke (7d) | **38%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 0% | nullstilles 18:50 UTC |
| Siste 7 dager | topp 100% · snitt 42% | 17t i sparemodus |

<sub>Oppdatert 2026-08-01 14:00 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
