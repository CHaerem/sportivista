...
|---|---|---|
| Uke (7d) | **33%** 🟢 | ↓ −64pp siste 24t · nullstilles 2026-09-28 |
| Sesjon (5t) | 4% | nullstilles 13:50 UTC |
| Siste 7 dager | topp 97% · snitt 57% | 16t i sparemodus |

<sub>Oppdatert 2026-09-25 10:15 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
