...
|---|---|---|
| Uke (7d) | **6%** 🟢 | ↓ −81pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 23% | nullstilles 11:50 UTC |
| Siste 7 dager | topp 92% · snitt 65% | 56t i sparemodus |

<sub>Oppdatert 2026-08-17 10:51 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
