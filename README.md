...
| Siste 7 dager | topp 84% · snitt 57% | 32t i sparemodus |

<sub>Oppdatert 2026-08-15 17:39 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
