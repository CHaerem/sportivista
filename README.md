...
|---|---|---|
| Uke (7d) | **52%** 🟢 | ↑ +17pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 15% | nullstilles 23:20 UTC |
| Siste 7 dager | topp 92% · snitt 52% | 54t i sparemodus |

<sub>Oppdatert 2026-08-20 20:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
