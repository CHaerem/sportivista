...
| Sesjon (5t) | 7% | nullstilles 20:30 UTC |
| Siste 7 dager | topp 74% · snitt 40% | 1t i sparemodus |

<sub>Oppdatert 2026-08-13 18:10 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
