...
|---|---|---|
| Uke (7d) | **42%** 🟢 | ↑ +14pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 8% | nullstilles 13:10 UTC |
| Siste 7 dager | topp 92% · snitt 53% | 55t i sparemodus |

<sub>Oppdatert 2026-08-20 09:52 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
