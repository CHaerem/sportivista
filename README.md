...
|---|---|---|
| Uke (7d) | **5%** 🟢 | ↓ −42pp siste 24t · nullstilles 2026-08-10 |
| Sesjon (5t) | 3% | nullstilles 00:30 UTC |
| Siste 7 dager | topp 47% · snitt 26% | 0t i sparemodus |

<sub>Oppdatert 2026-08-03 21:32 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
