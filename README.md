...
|---|---|---|
| Uke (7d) | **23%** 🟢 | ↑ +14pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 3% | nullstilles 19:30 UTC |
| Siste 7 dager | topp 92% · snitt 60% | 55t i sparemodus |

<sub>Oppdatert 2026-08-18 14:55 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
