...
| Siste 7 dager | topp 47% · snitt 27% | 0t i sparemodus |

<sub>Oppdatert 2026-08-04 23:28 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
