...
|---|---|---|
| Uke (7d) | **28%** 🟢 | ↑ +11pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 15% | nullstilles 13:20 UTC |
| Siste 7 dager | topp 100% · snitt 58% | 33t i sparemodus |

<sub>Oppdatert 2026-07-30 12:55 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
