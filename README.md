...
|---|---|---|
| Uke (7d) | **8%** 🟢 | ↑ +4pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 1% | nullstilles 03:30 UTC |
| Siste 7 dager | topp 64% · snitt 33% | 0t i sparemodus |

<sub>Oppdatert 2026-09-03 00:20 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
