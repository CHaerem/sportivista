...
|---|---|---|
| Uke (7d) | **7%** 🟢 | ↓ −57pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 8% | nullstilles 20:10 UTC |
| Siste 7 dager | topp 64% · snitt 33% | 0t i sparemodus |

<sub>Oppdatert 2026-08-31 19:09 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
