...
|---|---|---|
| Uke (7d) | **34%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 1% | nullstilles 00:50 UTC |
| Siste 7 dager | topp 100% · snitt 46% | 21t i sparemodus |

<sub>Oppdatert 2026-07-31 21:31 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
