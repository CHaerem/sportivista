...
|---|---|---|
| Uke (7d) | **1%** 🟢 | ↓ −99pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 0% | nullstilles 17:20 UTC |
| Siste 7 dager | topp 100% · snitt 70% | 37t i sparemodus |

<sub>Oppdatert 2026-07-27 12:38 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
