...
|---|---|---|
| Uke (7d) | **64%** 🟢 | ↑ +1pp siste 24t · nullstilles 2026-08-31 |
| Sesjon (5t) | 1% | nullstilles 20:00 UTC |
| Siste 7 dager | topp 82% · snitt 32% | 5t i sparemodus |

<sub>Oppdatert 2026-08-30 19:20 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
