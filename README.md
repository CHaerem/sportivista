...
|---|---|---|
| Uke (7d) | **7%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-09-21 |
| Sesjon (5t) | 1% | nullstilles 01:20 UTC |
| Siste 7 dager | topp 56% · snitt 33% | 0t i sparemodus |

<sub>Oppdatert 2026-09-16 22:12 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
