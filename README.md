...
| Siste 7 dager | topp 89% · snitt 64% | 48t i sparemodus |

<sub>Oppdatert 2026-08-16 15:40 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
