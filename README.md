...
|---|---|---|
| Uke (7d) | **88%** 🟡 | ↑ +6pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 2% | nullstilles 14:40 UTC |
| Siste 7 dager | topp 88% · snitt 63% | 44t i sparemodus |

<sub>Oppdatert 2026-08-16 11:38 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
