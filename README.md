...
|---|---|---|
| Uke (7d) | **47%** 🟢 | ↑ +1pp siste 24t · nullstilles 2026-09-14 |
| Sesjon (5t) | 2% | nullstilles 16:30 UTC |
| Siste 7 dager | topp 81% · snitt 34% | 5t i sparemodus |

<sub>Oppdatert 2026-09-10 14:29 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
