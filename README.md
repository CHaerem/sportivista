...
|---|---|---|
| Uke (7d) | **7%** 🟢 | ↑ +7pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 6% | nullstilles 22:00 UTC |
| Siste 7 dager | topp 64% · snitt 35% | 0t i sparemodus |

<sub>Oppdatert 2026-09-02 18:46 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
