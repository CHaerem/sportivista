...
| Sesjon (5t) | 16% | nullstilles 21:50 UTC |
| Siste 7 dager | topp 92% · snitt 62% | 55t i sparemodus |

<sub>Oppdatert 2026-08-17 21:44 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
