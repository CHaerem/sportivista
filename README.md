...
|---|---|---|
| Uke (7d) | **12%** 🟢 | ↓ −33pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 39% | nullstilles 12:40 UTC |
| Siste 7 dager | topp 68% · snitt 24% | 0t i sparemodus |

<sub>Oppdatert 2026-08-10 10:38 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
