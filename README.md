...
| Siste 7 dager | topp 100% · snitt 28% | 2t i sparemodus |

<sub>Oppdatert 2026-08-02 22:13 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
