...
|---|---|---|
| Uke (7d) | **65%** 🟢 | ↑ +11pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 0% | nullstilles 14:20 UTC |
| Siste 7 dager | topp 92% · snitt 48% | 32t i sparemodus |

<sub>Oppdatert 2026-08-22 09:45 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
