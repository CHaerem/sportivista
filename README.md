...
|---|---|---|
| Uke (7d) | **2%** 🟢 | ↓ −33pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 16% | nullstilles 07:30 UTC |
| Siste 7 dager | topp 68% · snitt 25% | 0t i sparemodus |

<sub>Oppdatert 2026-08-10 06:44 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
