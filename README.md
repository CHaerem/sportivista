...
|---|---|---|
| Uke (7d) | **40%** 🟢 | ↑ +12pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 14% | nullstilles 08:10 UTC |
| Siste 7 dager | topp 92% · snitt 54% | 55t i sparemodus |

<sub>Oppdatert 2026-08-20 07:59 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
