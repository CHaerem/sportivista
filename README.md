...
|---|---|---|
| Uke (7d) | **69%** 🟢 | ↑ +10pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 15% | nullstilles 19:20 UTC |
| Siste 7 dager | topp 92% · snitt 47% | 23t i sparemodus |

<sub>Oppdatert 2026-08-22 18:51 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
