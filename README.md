...
|---|---|---|
| Uke (7d) | **8%** 🟢 | ↓ −80pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 7% | nullstilles 16:50 UTC |
| Siste 7 dager | topp 92% · snitt 65% | 55t i sparemodus |

<sub>Oppdatert 2026-08-17 13:10 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
