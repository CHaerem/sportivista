...
|---|---|---|
| Uke (7d) | **22%** 🟡 | ↓ −27pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 89% | nullstilles 12:40 UTC |
| Siste 7 dager | topp 68% · snitt 24% | 1t i sparemodus |

<sub>Oppdatert 2026-08-10 12:02 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
