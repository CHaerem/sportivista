...
|---|---|---|
| Uke (7d) | **49%** 🟢 | ↑ +42pp siste 24t · nullstilles 2026-09-21 |
| Sesjon (5t) | 40% | nullstilles 01:00 UTC |
| Siste 7 dager | topp 56% · snitt 30% | 0t i sparemodus |

<sub>Oppdatert 2026-09-18 00:26 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
