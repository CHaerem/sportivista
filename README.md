...
| Siste 7 dager | topp 100% · snitt 54% | 28t i sparemodus |

<sub>Oppdatert 2026-07-30 23:28 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
