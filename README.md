...
|---|---|---|
| Uke (7d) | **47%** 🟢 | ↑ +6pp siste 24t · nullstilles 2026-09-14 |
| Sesjon (5t) | 1% | nullstilles 10:10 UTC |
| Siste 7 dager | topp 81% · snitt 33% | 5t i sparemodus |

<sub>Oppdatert 2026-09-10 09:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
