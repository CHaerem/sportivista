...
| Sesjon (5t) | 39% | nullstilles 23:10 UTC |
| Siste 7 dager | topp 47% · snitt 21% | 0t i sparemodus |

<sub>Oppdatert 2026-08-08 21:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
