...
|---|---|---|
| Uke (7d) | **55%** 🟢 | ↑ +13pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 3% | nullstilles 11:50 UTC |
| Siste 7 dager | topp 92% · snitt 51% | 49t i sparemodus |

<sub>Oppdatert 2026-08-21 09:54 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
