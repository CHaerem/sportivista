...
| Siste 7 dager | topp 100% · snitt 51% | 25t i sparemodus |

<sub>Oppdatert 2026-07-31 13:09 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
