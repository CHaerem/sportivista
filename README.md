...
|---|---|---|
| Uke (7d) | **70%** 🟢 | ↑ +17pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 7% | nullstilles 15:20 UTC |
| Siste 7 dager | topp 70% · snitt 38% | 1t i sparemodus |

<sub>Oppdatert 2026-08-13 12:02 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
