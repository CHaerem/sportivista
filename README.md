...
|---|---|---|
| Uke (7d) | **87%** 🟡 | ↑ +6pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 0% | nullstilles 14:40 UTC |
| Siste 7 dager | topp 87% · snitt 62% | 42t i sparemodus |

<sub>Oppdatert 2026-08-16 09:46 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
