...
| Siste 7 dager | topp 90% · snitt 66% | 54t i sparemodus |

<sub>Oppdatert 2026-08-16 21:37 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
