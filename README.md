...
|---|---|---|
| Uke (7d) | **77%** 🟡 | ↑ +4pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 3% | nullstilles 17:50 UTC |
| Siste 7 dager | topp 77% · snitt 46% | 12t i sparemodus |

<sub>Oppdatert 2026-08-14 16:07 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
