...
|---|---|---|
| Uke (7d) | **77%** 🟡 | ↑ +7pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 1% | nullstilles 17:50 UTC |
| Siste 7 dager | topp 77% · snitt 45% | 10t i sparemodus |

<sub>Oppdatert 2026-08-14 13:47 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
