...
| Siste 7 dager | topp 92% · snitt 48% | 26t i sparemodus |

<sub>Oppdatert 2026-08-22 16:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
