...
|---|---|---|
| Uke (7d) | **78%** 🟡 | ↑ +12pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 1% | nullstilles 16:50 UTC |
| Siste 7 dager | topp 92% · snitt 46% | 15t i sparemodus |

<sub>Oppdatert 2026-08-23 13:48 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
