...
| Siste 7 dager | topp 92% · snitt 47% | 22t i sparemodus |

<sub>Oppdatert 2026-08-22 19:39 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
