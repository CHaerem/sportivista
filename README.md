...
| Sesjon (5t) | 1% | nullstilles 18:50 UTC |
| Siste 7 dager | topp 100% · snitt 40% | 15t i sparemodus |

<sub>Oppdatert 2026-08-01 15:31 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
