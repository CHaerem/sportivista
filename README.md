...
|---|---|---|
| Uke (7d) | **54%** 🟢 | ↑ +15pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 3% | nullstilles 06:50 UTC |
| Siste 7 dager | topp 92% · snitt 51% | 51t i sparemodus |

<sub>Oppdatert 2026-08-21 05:50 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
