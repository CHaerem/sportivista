...
|---|---|---|
| Uke (7d) | **85%** 🟡 | ↑ +6pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 0% | nullstilles 03:40 UTC |
| Siste 7 dager | topp 85% · snitt 60% | 37t i sparemodus |

<sub>Oppdatert 2026-08-15 22:41 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
