...
| Sesjon (5t) | 26% | nullstilles 11:50 UTC |
| Siste 7 dager | topp 92% · snitt 46% | 15t i sparemodus |

<sub>Oppdatert 2026-08-23 09:46 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
