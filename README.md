...
|---|---|---|
| Uke (7d) | **33%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 2% | nullstilles 19:20 UTC |
| Siste 7 dager | topp 100% · snitt 50% | 24t i sparemodus |

<sub>Oppdatert 2026-07-31 15:31 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
