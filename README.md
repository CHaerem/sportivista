...
| Siste 7 dager | topp 100% · snitt 37% | 12t i sparemodus |

<sub>Oppdatert 2026-08-01 21:12 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
