...
|---|---|---|
| Uke (7d) | **75%** 🟡 | ↑ +14pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 1% | nullstilles 01:30 UTC |
| Siste 7 dager | topp 75% · snitt 41% | 5t i sparemodus |

<sub>Oppdatert 2026-08-13 23:05 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
