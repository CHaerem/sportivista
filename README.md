...
| Siste 7 dager | topp 85% · snitt 59% | 36t i sparemodus |

<sub>Oppdatert 2026-08-15 21:38 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
