...
|---|---|---|
| Uke (7d) | **69%** 🟢 | ↑ +16pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 2% | nullstilles 15:20 UTC |
| Siste 7 dager | topp 69% · snitt 37% | 1t i sparemodus |

<sub>Oppdatert 2026-08-13 10:30 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
