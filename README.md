...
|---|---|---|
| Uke (7d) | **49%** 🟢 | ↑ +16pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 21% | nullstilles 18:10 UTC |
| Siste 7 dager | topp 92% · snitt 52% | 55t i sparemodus |

<sub>Oppdatert 2026-08-20 17:48 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
