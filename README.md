...
| Siste 7 dager | topp 100% · snitt 65% | 36t i sparemodus |

<sub>Oppdatert 2026-07-25 17:25 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
