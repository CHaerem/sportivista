...
|---|---|---|
| Uke (7d) | **12%** 🟢 | ↑ +9pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 40% | nullstilles 08:40 UTC |
| Siste 7 dager | topp 100% · snitt 67% | 37t i sparemodus |

<sub>Oppdatert 2026-07-29 08:00 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
