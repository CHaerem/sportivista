...
|---|---|---|
| Uke (7d) | **28%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 4% | nullstilles 19:00 UTC |
| Siste 7 dager | topp 100% · snitt 56% | 31t i sparemodus |

<sub>Oppdatert 2026-07-30 17:52 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
