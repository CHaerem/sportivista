...
|---|---|---|
| Uke (7d) | **55%** 🟢 | ↑ +2pp siste 24t · nullstilles 2026-09-14 |
| Sesjon (5t) | 0% | nullstilles 19:40 UTC |
| Siste 7 dager | topp 81% · snitt 47% | 3t i sparemodus |

<sub>Oppdatert 2026-09-13 14:56 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
