...
|---|---|---|
| Uke (7d) | **31%** 🔴 | ↑ +13pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 95% | nullstilles 19:20 UTC |
| Siste 7 dager | topp 64% · snitt 19% | 1t i sparemodus |

<sub>Oppdatert 2026-09-05 18:22 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
