...
| Siste 7 dager | topp 81% · snitt 46% | 3t i sparemodus |

<sub>Oppdatert 2026-09-13 18:14 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
