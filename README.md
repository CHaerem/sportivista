...
|---|---|---|
| Uke (7d) | **33%** 🟢 | ↑ +10pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 13% | nullstilles 17:00 UTC |
| Siste 7 dager | topp 92% · snitt 56% | 55t i sparemodus |

<sub>Oppdatert 2026-08-19 14:55 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
