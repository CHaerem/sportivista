...
|---|---|---|
| Uke (7d) | **36%** 🟢 | ↑ +4pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 6% | nullstilles 13:50 UTC |
| Siste 7 dager | topp 100% · snitt 43% | 18t i sparemodus |

<sub>Oppdatert 2026-08-01 10:11 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
