...
|---|---|---|
| Uke (7d) | **47%** 🟢 | ↑ +9pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 10% | nullstilles 00:10 UTC |
| Siste 7 dager | topp 100% · snitt 29% | 3t i sparemodus |

<sub>Oppdatert 2026-08-02 21:12 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
