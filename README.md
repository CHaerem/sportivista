...
|---|---|---|
| Uke (7d) | **80%** 🟡 | ↑ +12pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 0% | nullstilles 21:50 UTC |
| Siste 7 dager | topp 92% · snitt 45% | 15t i sparemodus |

<sub>Oppdatert 2026-08-23 18:51 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
