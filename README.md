...
|---|---|---|
| Uke (7d) | **51%** 🟢 | ↑ +29pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 58% | nullstilles 15:00 UTC |
| Siste 7 dager | topp 68% · snitt 28% | 1t i sparemodus |

<sub>Oppdatert 2026-08-11 13:47 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
