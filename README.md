...
|---|---|---|
| Uke (7d) | **44%** 🟢 | ↑ +14pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 15% | nullstilles 13:10 UTC |
| Siste 7 dager | topp 92% · snitt 53% | 55t i sparemodus |

<sub>Oppdatert 2026-08-20 11:46 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
