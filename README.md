...
| Siste 7 dager | topp 80% · snitt 51% | 22t i sparemodus |

<sub>Oppdatert 2026-08-15 07:46 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
