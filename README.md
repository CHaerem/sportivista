...
|---|---|---|
| Uke (7d) | **86%** 🟡 | ↑ +6pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 1% | nullstilles 09:30 UTC |
| Siste 7 dager | topp 86% · snitt 60% | 38t i sparemodus |

<sub>Oppdatert 2026-08-16 05:47 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
