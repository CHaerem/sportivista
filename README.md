...
| Sesjon (5t) | 1% | nullstilles 15:40 UTC |
| Siste 7 dager | topp 82% · snitt 42% | 15t i sparemodus |

<sub>Oppdatert 2026-08-29 11:41 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
