...
| Sesjon (5t) | 0% | nullstilles 04:20 UTC |
| Siste 7 dager | topp 100% · snitt 71% | 37t i sparemodus |

<sub>Oppdatert 2026-07-27 23:29 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
