...
|---|---|---|
| Uke (7d) | **37%** 🟢 | ↑ +16pp siste 24t · nullstilles 2026-08-10 |
| Sesjon (5t) | 14% | nullstilles 10:00 UTC |
| Siste 7 dager | topp 47% · snitt 21% | 0t i sparemodus |

<sub>Oppdatert 2026-08-09 07:26 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
