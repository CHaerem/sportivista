...
| Siste 7 dager | topp 78% · snitt 47% | 14t i sparemodus |

<sub>Oppdatert 2026-08-14 18:08 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
