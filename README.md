...
|---|---|---|
| Uke (7d) | **1%** 🟢 | ↓ −39pp siste 24t · nullstilles 2026-08-10 |
| Sesjon (5t) | 10% | nullstilles 08:50 UTC |
| Siste 7 dager | topp 47% · snitt 25% | 0t i sparemodus |

<sub>Oppdatert 2026-08-03 08:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
