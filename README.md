...
|---|---|---|
| Uke (7d) | **5%** 🟢 | ↓ −32pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 6% | nullstilles 12:40 UTC |
| Siste 7 dager | topp 68% · snitt 25% | 0t i sparemodus |

<sub>Oppdatert 2026-08-10 08:53 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
