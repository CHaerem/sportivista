...
|---|---|---|
| Uke (7d) | **78%** 🟡 | ↑ +4pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 1% | nullstilles 22:50 UTC |
| Siste 7 dager | topp 78% · snitt 47% | 15t i sparemodus |

<sub>Oppdatert 2026-08-14 19:17 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
