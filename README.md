...
|---|---|---|
| Uke (7d) | **77%** 🟡 | ↑ +5pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 2% | nullstilles 17:50 UTC |
| Siste 7 dager | topp 77% · snitt 45% | 11t i sparemodus |

<sub>Oppdatert 2026-08-14 15:09 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
