...
|---|---|---|
| Uke (7d) | **24%** 🟢 | ↓ −28pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 5% | nullstilles 17:40 UTC |
| Siste 7 dager | topp 68% · snitt 25% | 1t i sparemodus |

<sub>Oppdatert 2026-08-10 13:48 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
