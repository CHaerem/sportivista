...
|---|---|---|
| Uke (7d) | **82%** 🟡 | ↑ +5pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 1% | nullstilles 17:00 UTC |
| Siste 7 dager | topp 82% · snitt 54% | 27t i sparemodus |

<sub>Oppdatert 2026-08-15 13:01 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
