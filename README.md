...
|---|---|---|
| Uke (7d) | **74%** 🟢 | ↑ +55pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 23% | nullstilles 20:10 UTC |
| Siste 7 dager | topp 74% · snitt 20% | 2t i sparemodus |

<sub>Oppdatert 2026-09-06 17:07 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
