...
| Sesjon (5t) | 0% | nullstilles 03:10 UTC |
| Siste 7 dager | topp 56% · snitt 39% | 0t i sparemodus |

<sub>Oppdatert 2026-09-15 22:18 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
