...
|---|---|---|
| Uke (7d) | **87%** 🟡 | ↑ +7pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 7% | nullstilles 09:30 UTC |
| Siste 7 dager | topp 87% · snitt 61% | 41t i sparemodus |

<sub>Oppdatert 2026-08-16 08:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
