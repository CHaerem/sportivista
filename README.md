...
|---|---|---|
| Uke (7d) | **50%** 🟢 | ↑ +42pp siste 24t · nullstilles 2026-09-28 |
| Sesjon (5t) | 42% | nullstilles 01:00 UTC |
| Siste 7 dager | topp 86% · snitt 46% | 11t i sparemodus |

<sub>Oppdatert 2026-09-23 00:42 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
