...
| Siste 7 dager | topp 56% · snitt 38% | 0t i sparemodus |

<sub>Oppdatert 2026-09-16 00:30 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
