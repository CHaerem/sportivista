...
|---|---|---|
| Uke (7d) | **80%** 🟡 | ↑ +4pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 0% | nullstilles 12:00 UTC |
| Siste 7 dager | topp 80% · snitt 50% | 21t i sparemodus |

<sub>Oppdatert 2026-08-15 07:01 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
