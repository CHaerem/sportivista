...
|---|---|---|
| Uke (7d) | **35%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 3% | nullstilles 08:50 UTC |
| Siste 7 dager | topp 100% · snitt 44% | 19t i sparemodus |

<sub>Oppdatert 2026-08-01 07:38 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
