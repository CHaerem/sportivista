...
|---|---|---|
| Uke (7d) | **13%** 🟢 | ↑ +7pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 0% | nullstilles 22:10 UTC |
| Siste 7 dager | topp 64% · snitt 30% | 0t i sparemodus |

<sub>Oppdatert 2026-09-03 18:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
