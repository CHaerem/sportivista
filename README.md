...
|---|---|---|
| Uke (7d) | **68%** 🟢 | ↑ +9pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 7% | nullstilles 19:20 UTC |
| Siste 7 dager | topp 92% · snitt 47% | 24t i sparemodus |

<sub>Oppdatert 2026-08-22 17:39 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
