...
|---|---|---|
| Uke (7d) | **53%** 🟢 | ↑ +13pp siste 24t · nullstilles 2026-08-17 |
| Sesjon (5t) | 2% | nullstilles 12:50 UTC |
| Siste 7 dager | topp 68% · snitt 32% | 1t i sparemodus |

<sub>Oppdatert 2026-08-12 10:29 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
