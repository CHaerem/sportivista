...
|---|---|---|
| Uke (7d) | **2%** 🟢 | ↓ −84pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 5% | nullstilles 11:50 UTC |
| Siste 7 dager | topp 92% · snitt 66% | 56t i sparemodus |

<sub>Oppdatert 2026-08-17 07:25 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
