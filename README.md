...
| Sesjon (5t) | 1% | nullstilles 18:40 UTC |
| Siste 7 dager | topp 68% · snitt 33% | 1t i sparemodus |

<sub>Oppdatert 2026-08-12 13:52 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
