...
| Sesjon (5t) | 3% | nullstilles 21:50 UTC |
| Siste 7 dager | topp 92% · snitt 50% | 42t i sparemodus |

<sub>Oppdatert 2026-08-21 19:00 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
