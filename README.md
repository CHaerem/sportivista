...
| Siste 7 dager | topp 86% · snitt 61% | 40t i sparemodus |

<sub>Oppdatert 2026-08-16 07:47 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
