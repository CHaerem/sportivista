...
|---|---|---|
| Uke (7d) | **100%** 🔴 | → 0pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 0% | nullstilles 23:20 UTC |
| Siste 7 dager | topp 100% · snitt 70% | 37t i sparemodus |

<sub>Oppdatert 2026-07-26 23:15 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
