...
|---|---|---|
| Uke (7d) | **55%** 🟢 | ↑ +48pp siste 24t · nullstilles 2026-09-21 |
| Sesjon (5t) | 18% | nullstilles 11:00 UTC |
| Siste 7 dager | topp 56% · snitt 30% | 0t i sparemodus |

<sub>Oppdatert 2026-09-18 09:51 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
