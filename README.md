...
|---|---|---|
| Uke (7d) | **11%** 🟢 | ↑ +6pp siste 24t · nullstilles 2026-09-07 |
| Sesjon (5t) | 0% | nullstilles 14:50 UTC |
| Siste 7 dager | topp 64% · snitt 32% | 0t i sparemodus |

<sub>Oppdatert 2026-09-03 09:55 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
