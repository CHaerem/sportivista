...
| Sesjon (5t) | 0% | nullstilles 16:20 UTC |
| Siste 7 dager | topp 100% · snitt 70% | 37t i sparemodus |

<sub>Oppdatert 2026-07-28 13:03 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
