...
| Sesjon (5t) | 2% | nullstilles 16:10 UTC |
| Siste 7 dager | topp 47% · snitt 23% | 0t i sparemodus |

<sub>Oppdatert 2026-08-07 15:12 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
