...
| Siste 7 dager | topp 81% · snitt 35% | 5t i sparemodus |

<sub>Oppdatert 2026-09-10 21:40 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
