...
|---|---|---|
| Uke (7d) | **15%** 🟢 | ↓ −73pp siste 24t · nullstilles 2026-09-28 |
| Sesjon (5t) | 7% | nullstilles 22:50 UTC |
| Siste 7 dager | topp 97% · snitt 58% | 16t i sparemodus |

<sub>Oppdatert 2026-09-24 19:15 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
