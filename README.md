...
|---|---|---|
| Uke (7d) | **54%** 🟢 | ↑ +2pp siste 24t · nullstilles 2026-09-14 |
| Sesjon (5t) | 2% | nullstilles 20:30 UTC |
| Siste 7 dager | topp 81% · snitt 47% | 4t i sparemodus |

<sub>Oppdatert 2026-09-12 19:26 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
