...
|---|---|---|
| Uke (7d) | **34%** 🟢 | ↑ +10pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 6% | nullstilles 22:00 UTC |
| Siste 7 dager | topp 92% · snitt 55% | 55t i sparemodus |

<sub>Oppdatert 2026-08-19 18:56 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
