...
| Sesjon (5t) | 15% | nullstilles 09:20 UTC |
| Siste 7 dager | topp 92% · snitt 48% | 33t i sparemodus |

<sub>Oppdatert 2026-08-22 08:50 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
