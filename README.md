...
|---|---|---|
| Uke (7d) | **17%** 🟢 | ↑ +14pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 17% | nullstilles 13:40 UTC |
| Siste 7 dager | topp 100% · snitt 66% | 37t i sparemodus |

<sub>Oppdatert 2026-07-29 10:58 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
