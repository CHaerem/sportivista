...
| Siste 7 dager | topp 92% · snitt 48% | 29t i sparemodus |

<sub>Oppdatert 2026-08-22 13:03 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
