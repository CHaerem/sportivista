...
|---|---|---|
| Uke (7d) | **50%** 🟢 | ↑ +16pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 6% | nullstilles 23:20 UTC |
| Siste 7 dager | topp 92% · snitt 52% | 55t i sparemodus |

<sub>Oppdatert 2026-08-20 19:04 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
