...
|---|---|---|
| Uke (7d) | **19%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-08-10 |
| Sesjon (5t) | 6% | nullstilles 10:50 UTC |
| Siste 7 dager | topp 47% · snitt 24% | 0t i sparemodus |

<sub>Oppdatert 2026-08-07 08:31 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
