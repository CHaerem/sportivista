...
| Sesjon (5t) | 6% | nullstilles 14:40 UTC |
| Siste 7 dager | topp 88% · snitt 63% | 45t i sparemodus |

<sub>Oppdatert 2026-08-16 13:03 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
