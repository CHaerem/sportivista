...
| Siste 7 dager | topp 81% · snitt 46% | 5t i sparemodus |

<sub>Oppdatert 2026-09-12 17:15 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
