...
|---|---|---|
| Uke (7d) | **33%** 🟢 | ↑ +7pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 2% | nullstilles 14:20 UTC |
| Siste 7 dager | topp 100% · snitt 52% | 26t i sparemodus |

<sub>Oppdatert 2026-07-31 11:01 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
