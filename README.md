...
|---|---|---|
| Uke (7d) | **71%** 🟢 | ↑ +11pp siste 24t · nullstilles 2026-08-24 |
| Sesjon (5t) | 11% | nullstilles 00:30 UTC |
| Siste 7 dager | topp 92% · snitt 47% | 19t i sparemodus |

<sub>Oppdatert 2026-08-22 22:41 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
