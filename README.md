...
|---|---|---|
| Uke (7d) | **3%** 🟢 | ↓ −97pp siste 24t · nullstilles 2026-08-03 |
| Sesjon (5t) | 2% | nullstilles 11:20 UTC |
| Siste 7 dager | topp 100% · snitt 70% | 37t i sparemodus |

<sub>Oppdatert 2026-07-28 07:56 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
