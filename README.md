...
| Sesjon (5t) | 0% | nullstilles 10:10 UTC |
| Siste 7 dager | topp 100% · snitt 67% | 37t i sparemodus |

<sub>Oppdatert 2026-07-26 10:14 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
